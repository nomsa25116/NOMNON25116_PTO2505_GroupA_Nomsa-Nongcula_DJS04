...
export const PodcastContext = createContext();
  ...
  * 
  * @param{{childern: React.ReactNode, initialPodcasts: Podcast[]}} props
  * @return {JSX.Element}
  */
export function PodcastProvider({ children, initialPodcasts = [] }) {
    ...
    useEffect(() => {
        const calculatePageSize = () => {
            ...
            //Tablet and smaller screens (1024px and below): always show 10 cards
            if (screenW <= 1024) {
                setPageSize(10);
                return;
            }
    ...
    const paged = filtered.slice((currentPage - 1) * pageSize,
